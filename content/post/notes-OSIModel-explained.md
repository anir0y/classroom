...
![Notes OSIModel Explained — Packet Details](https://i.imgur.com/7t17lRS.png)
...
![Notes OSIModel Explained — Packet Details (2)](https://i.imgur.com/FcyFnvP.png)

* Source [MAC] (Layer 2) -- This will show you the source and destination MAC Addresses; from the Data Link layer of the OSI model
![Notes OSIModel Explained — Packet Details (3)](https://i.imgur.com/FhMBxhJ.png)

* Source [IP] (Layer 3) -- This will show you the source and destination IPv4 Addresses; from the Network layer of the OSI model.
![Notes OSIModel Explained — Packet Details (4)](https://i.imgur.com/ePKFM8U.png)
...
![Notes OSIModel Explained — Packet Details (5)](https://i.imgur.com/Qo15Yi0.png)

* Protocol Errors -- This is a continuation of the 4th layer showing specific segments from TCP that needed to be reassembled.
![Notes OSIModel Explained — Packet Details (6)](https://i.imgur.com/Y6gFzip.png)
...
![Notes OSIModel Explained — Packet Details (7)](https://i.imgur.com/iIokXva.png)

* Application Data -- This is an extension of layer 5 that can show the application-specific data
![Notes OSIModel Explained — Packet Details (8)](https://i.imgur.com/VBv5cHG.png)
