...
![autopsy-on-kali-linux](https://assets.tryhackme.com/additional/autopsy/autopsy-kali2.png)
...
![autopsy-new-case-dialog](https://i.imgur.com/eaXIpmE.png)

The next screen is titled Case Information, and this is where information about the case is populated.   
![case-information-screen](https://i.imgur.com/59cPhds.png)  

![optional-information-screen](https://i.imgur.com/11aCMtf.png)
...
![open-case-option](https://i.imgur.com/0DaKbH2.png)

Autopsy case files have an `.aut` file extension. Navigate to the case folder and select the .aut file you wish to open. 

![autopsy-aut-file-selection](https://assets.tryhackme.com/additional/autopsy/autopsy-autfile2.png)
...
![autopsy-case-name-header](https://i.imgur.com/jnKZJuJ.png)
...
![missing-image-warning](https://i.imgur.com/My6C5jC.png)
...
![add-data-source-dialog](https://i.imgur.com/HEQ70KH.png)
...
![disk-image-data-source](https://i.imgur.com/vLLi9Cl.png)
...
![configure-ingest-modules](https://i.imgur.com/30dd6LE.png)

By default, the Ingest Modules are configured to run on All Files, Directories, and Unallocated Space.    

![ingest-module-file-filter](https://i.imgur.com/b7RzSDo.png)
...
![autopsy-processing-data](https://i.imgur.com/7CHIMik.png)
...
![ingest-complete-notification](https://i.imgur.com/lVBLIqC.png)
...
![empty-results-node](https://i.imgur.com/ZhLvgUj.png)
...
![run-ingest-modules-menu](https://i.imgur.com/tfOzjy8.png)

As Ingest Modules run, alerts may appear in the Ingest Inbox.   
![ingest-inbox-alerts](https://i.imgur.com/aqdxEMm.png)

Below is an example of the Ingest Inbox after a few Ingest Modules have completed running.

![ingest-inbox-results](https://i.imgur.com/ysjqXIQ.png)
...
### Tree Viewer
![tree-viewer-pane](https://i.imgur.com/Ga07qk6.png)
...
![result-viewer-data-source](https://i.imgur.com/HwtRmc7.png)
...
![result-viewer-volume-info](https://i.imgur.com/jlWgNHL.png)
...
![file-types-by-extension](https://i.imgur.com/FzWQwmg.png)
...
![contents-viewer-pane](https://i.imgur.com/n1lCyMI.png)
...
![keyword-search-interface](https://i.imgur.com/qwF9uTV.png)

In the image above, the analyst is searching for the word 'secret.' Below are the search results. 

![keyword-search-results](https://i.imgur.com/5bVyN4c.png)
...
![status-area-progress-bar](https://i.imgur.com/e7u4wFA.png)
...
![missing-image-prompt](https://i.imgur.com/pH9PgjS.png)
...
### Flag-7.1 
![task-7-1-os-version-answer](https://i.imgur.com/JKXRyqT.png)

### Flag-7.2
Click on Disk -> Listing -> Summery 

![task-7-2-disk-summary](https://i.imgur.com/I5eFxzr.png)

### Flag-7.3

Summery tab has the answers   

![task-7-3-file-events-date](https://i.imgur.com/lrXYXXe.png)

### Flag-7.4

![task-7-4-installed-programs](https://i.imgur.com/CHbc7GT.png)

### Flag-7.5

![task-7-5-answer](https://i.imgur.com/G02O9te.png)

### Flag-7.6

![task-7-6-answer](https://i.imgur.com/uF9tzSr.png)
...
![task-7-7-search-results](https://i.imgur.com/iHGSAea.png)

### Flag-7.8

TimeStamp was helpful 

![task-7-8-timestamp-answer](https://i.imgur.com/MStRVyw.png)

### Flag-7.9

![task-7-9-answer](https://i.imgur.com/3F2vi0u.png)

### Flag-7.10

![task-7-10-answer](https://i.imgur.com/IDXtMr3.png)


## Task 08: Visualization Tools

![visualization-tools-menu](https://i.imgur.com/MsOZAMp.png)
...
![timeline-counts-view](https://i.imgur.com/fBPPnYz.png)
...
![timeline-details-view](https://i.imgur.com/RpxQpGf.png)
...
![timeline-clustered-events](https://i.imgur.com/qCYmWA5.png)

To expand a cluster, click on the `green icon with the plus sign`. See the below example.

![timeline-expand-cluster](https://i.imgur.com/goYJm8p.png)
...
![timeline-pin-events](https://i.imgur.com/tj8eHlW.png)
...
![timeline-hidden-descriptions](https://i.imgur.com/pGPnSfr.png)
...
![timeline-unhide-events](https://i.imgur.com/RbGqkHV.png)

Last but not least, below is a screenshot of the List View Mode.

![timeline-list-view](https://i.imgur.com/lRHeV9W.png)
...
![task-8-timeline-answer](https://i.imgur.com/8fXs1tu.png)
